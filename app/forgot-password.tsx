...
export default function ForgotPasswordScreen() {
  ...
  const { forgotPassword, isSendingReset, verifyResetOtp, isVerifyingOtp } =
    useAuth();
              ...
              {!emailSentTo ? (
                <>
                  ...
                  <Text className="font-inter text-base text-v2-text-muted text-center mb-8">
                    Enter your email address and we'll send you an 8-digit code
                ...
                <>
                  ...
                  <Text className="font-inter text-base text-v2-text-muted text-center mb-8">
                    Please check your email. Enter the 8-digit code we sent to{" "}
                    <Text className="font-inter-bold">{emailSentTo}</Text>.
                  </Text>
                  ...
                  <View className="gap-4">
                    ...
                    <Button
                      title={
                        isVerifyingOtp ? "Verifying..." : "Confirm & Continue"
                      }
                      variant="primary"
                      size="lg"
                      fullWidth
                      onPress={() =>
                        verifyResetOtp({ email: emailSentTo, token: otpCode })
                      }
                      className="mt-4"
                    ...
                    >
                      <Text className="text-v2-text-muted font-inter-medium text-base">
                        ...
                        <Text className="text-v2-text-body underline">
                          Go back
                        </Text>
                      </Text>
                    </TouchableOpacity>
